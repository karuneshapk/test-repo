...
module.exports = (new Config()).extend(
  path.join(settings.APOLLO_CONFIGURATION_ROOT_PATH, 'webpack.appstore.[env].config.js'),
  path.join(settings.APOLLO_CONFIGURATION_ROOT_PATH, 'webpack/configs/dll.input.js')
)
